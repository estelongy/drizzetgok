...
export const GUIDES: GuideData[] = [
  ...
  },
  {
    ...
    updated: '2026-06-24',
    relatedServiceSlug: 'dolgu',
    relatedGuides: ['caha-radiesse-nedir', 'sivi-yuz-germe-nedir', 'dolgu', 'dudak-dolgusu'],
  ...
  {
    slug: 'sivi-yuz-germe-nedir',
    category: 'Sıvı Yüz Germe',
    title: 'Sıvı Yüz Germe (Liquid Facelift) Nedir? — Kapsamlı Rehber',
    metaTitle: 'Sıvı Yüz Germe Nedir? Nasıl Yapılır, Kaç Ay Kalır, Kimlere Uygun? | Dr. İzzet Gök',
    excerpt:
      'Sıvı yüz germe (liquid facelift) nedir, nasıl çalışır, ameliyattan farkı nedir ve kimlere uygundur? Yüz yaşlanmasının katman katman mekanizması, 8 nokta / MD Codes tekniği, botoks-dolgu-biyostimülatör sinerjisi — Dr. İzzet Gök kontrolünde, bilimsel dayanaklı ve görsel anlatımla.',
    heroEyebrow: 'Medikal Estetik Rehberi',
    readingMinutes: 13,
    updated: '2026-09-01',
    relatedServiceSlug: 'sivi-yuz-germe',
    relatedGuides: ['caha-radiesse-nedir', 'plla-sculptra-nedir', 'pcl-ellanse-nedir', 'ha-biyostimulator-farki'],
    color: 'from-violet-500 to-purple-500',
    blocks: [
      {
        type: 'prose',
        heading: 'Sıvı yüz germe tam olarak nedir?',
        paragraphs: [
          'Sıvı yüz germe (İngilizcesiyle “liquid facelift”), yüzdeki belirli anatomik noktalara enjekte edilen dolgu, botoks ve/veya biyostimülatör ürünlerin birlikte kullanılmasıyla, cerrahi olmadan yüz hatlarını yukarı taşıyan, hacim kaybını gideren ve daha dinlenmiş bir görünüm sağlayan bütüncül bir medikal estetik protokolüdür. “Sıvı” adı, bıçak yerine enjeksiyonla — yani sıvı ürünlerle — çalışılmasından gelir.',
          'Bu bir tek işlem değil, bir planlama biçimidir. Amaç tek bir çizgiyi doldurmak değil; yüzü bir bütün olarak okuyup, sarkmanın ve hacim kaybının başladığı temel noktalardan destekleyerek yüzü “yukarı” hissettirmektir. İyi yapılmış bir sıvı yüz germede sonuç “doldurulmuş” değil, “dinlenmiş ve toparlanmış” görünür.',
        ],
      },
      {
        type: 'callout',
        tone: 'info',
        title: 'İsimler karışmasın',
        text: 'Sıvı yüz germe; “liquid facelift”, “cerrahisiz yüz germe”, “8 nokta germe” ve “bıçaksız yüz germe” adlarıyla da anılır. Hepsi aynı mantığı tanımlar: enjeksiyonla, cerrahi olmadan yüzü destekleme. Ameliyatlı yüz germe (ritidektomi) ile aynı şey değildir; farkını aşağıda ayrı bir bölümde ele alıyoruz.',
      },
      {
        type: 'science',
        title: 'Yüz neden yaşlanır? — Katman katman gerçek mekanizma',
        paragraphs: [
          'Yüz yaşlanması yalnızca “ciltteki kırışıklık” değildir; yüzü oluşturan tüm katmanların birlikte değişmesidir. Bilimsel literatür yaşlanmayı dört ana katmanda tanımlar: kemik, yağ, bağ dokusu (ligamentler) ve cilt. Sarkma dediğimiz görüntü, bu katmanların hep birlikte aşağı ve içeri doğru değişmesinin sonucudur.',
          'Kemik düzeyinde, göz çukuru kenarları ve çene açısı gibi bölgelerde yaşla birlikte kemik geri çekilir (rezorpsiyon); yani yüzün “iskele”si küçülür ve üstündeki yumuşak dokular desteğini kaybeder. Yağ düzeyinde, yüz tek bir yağ tabakası değil, ayrı ayrı “yağ kompartmanlarına” bölünmüştür; yaşla bu kompartmanlar hem küçülür hem aşağı kayar. Özellikle orta yüzdeki hacim kaybı, elmacık bölgesinin düşmesine ve nazolabial (burun-dudak) hattının belirginleşmesine yol açar.',
          'Bağ dokusu düzeyinde, yüzü asan “ligament hattı” gevşer; bu, yanak ve alt yüzün sarkmasında kritik rol oynar. Cilt düzeyinde ise kolajen ve elastin azalır, cilt inceler ve esnekliğini yitirir. Sıvı yüz germenin mantığı tam da buradan doğar: yüzeydeki çizgiyi kovalamak yerine, sarkmanın kaynağı olan derin destek noktalarını yeniden desteklemek.',
        ],
      },
      {
        type: 'image',
        src: '/images/sivi-yuz-germe-anatomi.png',
        alt: 'Yüz yaşlanmasının dört katmanı: kemik geri çekilmesi (orbital, maksilla, mandibula), yağ kompartmanlarının küçülüp aşağı kayması, ligament gevşemesi (orbital, zigomatik, mandibular) ve cilt kolajen kaybı',
        caption: 'Yaşlanma dört katmanda birlikte olur: kemik, yağ kompartmanları, ligamentler ve cilt. Sıvı yüz germe yüzeydeki çizgiyi değil, sarkmanın kaynağı olan derin destek noktalarını hedefler. (Kavramsal anlatım — bilgilendirme amaçlıdır.)',
      },
      {
        type: 'prose',
        heading: 'Nasıl çalışır? — “Yukarı taşıma” mantığı',
        paragraphs: [
          'Sıvı yüz germe, yüzü aşağı çeken sürecin tersini kurgular. Hacmin kaybolduğu derin noktalara (örneğin elmacık üstü, şakak, çene hattı) doğru üründen, doğru katmana kontrollü destek verilir. Bu destek noktaları, üstlerindeki dokuyu adeta bir çadır direği gibi yukarı taşır; böylece nazolabial hat, ağız kenarı ve gerdan gibi “sonuç bölgeleri” doğrudan doldurulmadan, kaynaktan rahatlar.',
          'Bu yaklaşımın en bilinen sistematiği, Dr. Mauricio de Maio tarafından geliştirilen 8 nokta tekniği ve MD Codes haritalamasıdır. Klinik gözlemler, şakak ve dış yanak bölgesindeki (lateral temporal-cheek) destek noktalarının, tek başına o bölgeyi değil, alın ve orta yüz dahil geniş bir alanı toparlayabildiğini göstermiştir. Yani doğru noktaya verilen az miktar destek, yüzün genelinde “yukarı” etkisi yaratabilir.',
        ],
      },
      {
        type: 'list',
        heading: 'Sıvı yüz germenin üç uygulaması — ne işe yarar?',
        items: [
          { title: 'Hyaluronik asit (HA) dolgular', text: 'Anında hacim ve destek verir; ciltte doğal bulunan HA yapısındadır ve gerektiğinde hyaluronidaz enzimiyle çözülebilir (geri alınabilir). Elmacık, çene hattı ve şakak gibi taşıyıcı noktalarda kullanılır.' },
          { title: 'Botulinum toksin (botoks)', text: 'Üst yüzdeki mimik kaynaklı çizgileri (alın, kaş arası, kaz ayağı) yumuşatır. Dolgunun hacim işini yaparken botoks ifadeyi dinlendirir; ikisi birbirini tamamlar.' },
          { title: 'Biyostimülatörler (CaHA, PLLA, PCL)', text: 'Hacmi doğrudan “eklemek” yerine cildin kendi kolajenini yeniden üretmesini uyarır. Cilt kalitesini ve toparlanmayı zamanla içeriden iyileştirir; sıvı yüz germede giderek daha çok tercih edilir.' },
        ],
      },
      {
        type: 'prose',
        heading: 'Sıvı yüz germe uygulamaları — üç farklı etki, üç tamamlayıcı rol',
        paragraphs: [
          'Aşağıdaki karşılaştırma, sıvı yüz germede kullanılan üç uygulamanın rollerini bir arada gösterir: HA dolgu anında hacim ve destek, botoks mimik kontrolü, biyostimülatör ise kolajen yenilenmesiyle uzun vadeli cilt kalitesi. Üçü farklı mekanizmalarla çalışır ve doğru planlandığında birbirini tamamlar.',
        ],
      },
      {
        type: 'image',
        src: '/images/sivi-yuz-germe-uygulamalari.png',
        alt: 'Sıvı yüz germe uygulamaları karşılaştırması: HA dolgu (anında hacim, 9-18 ay), botoks (mimik kontrolü, 3-6 ay) ve biyostimülatör (kolajen yenilenmesi, 12-24 ay)',
        caption: 'Üç uygulama, üç farklı mekanizma ve tamamlayıcı rol: HA dolgu anında hacim ve destek, botoks mimik çizgilerini yumuşatma, biyostimülatör ise kolajen yenilenmesiyle uzun vadeli cilt kalitesi sağlar. Etki başlangıcı ve süreleri birbirinden farklıdır.',
      },
      {
        type: 'callout',
        tone: 'info',
      ...
      {
        type: 'comparison',
        heading: 'Sıvı yüz germe mi, ameliyatlı yüz germe mi?',
        leftTitle: 'Sıvı yüz germe (enjeksiyon)',
        rightTitle: 'Ameliyatlı yüz germe (ritidektomi)',
        left: [
          'Cerrahi ve genel anestezi gerektirmez',
          'İyileşme süresi kısa; çoğu kişi ertesi gün hayatına döner',
          'Hacim kaybı ve erken-orta sarkmada güçlü etki',
          'HA ile geri alınabilir, kademeli ilerlenebilir',
          'Etki kalıcı değildir; yenileme gerekir',
        ],
        right: [
          'Cerrahi işlem ve anestezi gerektirir',
          'İyileşme haftalar sürebilir',
          'İleri derecede sarkma ve fazla deride daha etkilidir',
          'Sonuç uzun sürelidir ama geri alınamaz',
          'Hacim kaybını tek başına gidermeyebilir',
        ],
      },
      {
        type: 'callout',
        tone: 'warn',
        title: 'Sıvı yüz germe ameliyatın “yerine” geçer mi?',
        text: 'Her hastada değil. Erken-orta derece hacim kaybı ve sarkmada (çoğunlukla 35-55 yaş aralığında) enjeksiyonla belirgin toparlanma sağlanabilir. Ancak ileri derecede sarkma ve fazla deri varlığında cerrahi yüz germe daha doğru seçenek olabilir. Doğru kararı ancak hekim muayenesi verir; kimse fotoğrafa bakıp “sana şu yeter” diyemez.',
      },
      {
        type: 'comparison',
        heading: 'Kimlere uygun, kimlere uygun değil?',
        ...
        rightTitle: 'Ertelenmesi / değerlendirilmesi gerekenler',
        left: [
          'Yüzünde hacim kaybı ve erken-orta sarkma olanlar',
          'Cerrahiye hazır olmayan, kademeli çözüm isteyenler',
          'Kısa iyileşme süresi öncelik olanlar',
          'Gerçekçi beklentisi olanlar',
        ],
        right: [
          'Gebelik ve emzirme dönemindekiler',
          'Uygulama bölgesinde aktif cilt enfeksiyonu / aktif uçuk olanlar',
          'Bilinen ciddi alerji veya kanama bozukluğu olanlar',
          'İleri derecede sarkma ve fazla deri olanlar (cerrahi değerlendirmesi)',
        ],
      },
      {
        type: 'myths',
        heading: 'Mitler ve gerçekler',
        items: [
          { myth: 'Sıvı yüz germe yüzü şişirir, “dolu” gösterir mi?', truth: 'Hayır. Amaç hacim eklemek değil, kaybolan desteği doğru noktadan yerine koymaktır. Doğru planlamada yüz dolu değil, dinlenmiş görünür.' },
          { myth: 'Tek seansta 10 yaş gençleşirim.', truth: 'Gerçekçi değil. Sıvı yüz germe doğal ve dengeli bir tazelenme hedefler; abartılı vaatler bilimsel değildir.' },
          { myth: 'Enjeksiyon olduğu için risksizdir.', truth: 'Hayır. Her tıbbi işlem gibi riskleri vardır; en ciddi (nadir) risk damar tıkanıklığıdır. Bu yüzden yüz anatomisine hâkim bir hekim tarafından yapılmalıdır.' },
          { myth: 'Bir kez yaptırınca sürekli yaptırmak zorunda kalırım.', truth: 'Hayır. Etki azaldığında ürün doğal olarak emilir ve yüz eski haline döner; devam etmek tamamen tercihe bağlıdır.' },
          { myth: 'Sonuç anında ve kalıcıdır.', truth: 'HA dolgu kısmı anında görülür ama biyostimülatör etkisi aylar içinde oturur; hiçbir kısmı ömür boyu kalıcı değildir.' },
        ],
      },
      {
        type: 'prose',
        heading: 'Kalıcılık: ne kadar sürer?',
        paragraphs: [
          'Süre, protokolde hangi ürünlerin kullanıldığına bağlıdır. HA dolgularla kurulan sıvı yüz germe etkisi tipik olarak 12-18 ay arası korunur; kullanılan ürünün yoğunluğuna, uygulama bölgesine ve kişinin metabolizmasına göre değişir. Biyostimülatör içeren protokollerde cilt kalitesindeki iyileşme daha uzun sürebilir, çünkü etki cildin kendi kolajen üretimi üzerinden ilerler.',
          'Önemli nokta: sıvı yüz germe “bir kez yapılıp biten” değil, planlı yenilemelerle sürdürülen bir yaklaşımdır. Düzenli takip edildiğinde daha az ürünle daha uzun etki sağlanabilir; her yenileme öncekinin üzerine oturur.',
        ],
      },
      {
        type: 'callout',
        tone: 'info',
        title: 'Bu içerik bilgilendirme amaçlıdır',
        text: 'Sıvı yüz germe kişiye özel planlanan tıbbi bir uygulamadır. Buradaki bilgiler genel bir rehber niteliğindedir; hangi ürünün, hangi noktaya, ne miktarda uygulanacağı ancak yüz yüze muayene ile belirlenir. Karar öncesi mutlaka hekim değerlendirmesi şarttır.',
      },
      {
        type: 'faq',
        heading: 'Sıkça sorulan sorular',
        items: [
          { q: 'Sıvı yüz germe acır mı?', a: 'Krem anestezi ve dolguların içindeki anestezik madde sayesinde rahatsızlık genellikle azdır. Künt uçlu kanül kullanımı hem konforu artırır hem damar güvenliğini destekler.' },
          { q: 'İşlemden sonra ne kadar dinlenmeliyim?', a: 'Hafif şişlik ve kızarıklık genellikle 24-48 saatte geriler; çoğu hasta ertesi gün normal yaşamına döner. Olası morluk 3-7 günde solar.' },
          { q: 'Sonuç doğal görünür mü?', a: 'Doğru planlama ve dozda evet. Hedef “değişmiş” değil, “dinlenmiş” bir yüzdür; iyi yapılmış uygulama fark edilmez, sadece toparlanmış bir görünüm bırakır.' },
          { q: 'Kaç ay kalır?', a: 'HA temelli protokollerde tipik olarak 12-18 ay. Biyostimülatör içeren protokollerde cilt kalitesi iyileşmesi daha uzun sürebilir.' },
          { q: 'Botoks ve dolgu aynı işlemde yapılır mı?', a: 'Evet, sıklıkla birlikte planlanır. Botoks üst yüzdeki mimik çizgilerini dinlendirirken dolgu/biyostimülatör hacmi ve desteği sağlar; ikisi birbirini tamamlar.' },
          { q: 'Ameliyatlı yüz germeden farkı nedir?', a: 'Sıvı yüz germe cerrahi ve anestezi gerektirmez, iyileşmesi kısadır ve geri alınabilir (HA); ancak ileri sarkmada ameliyatlı yüz germe kadar etkili olmayabilir. Doğru seçenek muayene ile belirlenir.' },
        ],
      },
      {
        type: 'sources',
        heading: 'Kaynaklar ve bilimsel dayanak',
        items: [
          { label: 'Cotofana S, et al. Practical application of the facial fat compartments and the line of ligaments concept in achieving the lifting effect in the lower face. PMC.', url: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10082303/' },
          { label: 'de Maio M. MD Codes™: A Methodological Approach to Facial Aesthetic Treatment with Injectable Hyaluronic Acid Fillers. Aesthetic Plastic Surgery.' },
          { label: 'Quantified Evaluation of Whole Face 8-points Supra-periosteum High Molecular Weight HA Injection. ClinicalTrials.gov (NCT06871592).', url: 'https://clinicaltrials.gov/study/NCT06871592' },
          { label: 'U.S. Food & Drug Administration (FDA) — Dermal Fillers (Soft Tissue Fillers) hasta bilgilendirmesi.' },
          { label: 'T.C. Sağlık Bakanlığı, Türkiye İlaç ve Tıbbi Cihaz Kurumu (TİTCK) — dolgu ve botulinum toksin ürün ruhsatlandırma bilgileri.' },
        ],
      },
    ],
  },
  {
    ...
    title: 'Kalsiyum Hidroksiapatit Rehberi — CaHA Nedir? Biyostimülatörler (Radiesse, Novuma, HArmonyCa, Calhydra, Facetem vb.)',
    ...
    blocks: [
      {
        type: 'prose',
        heading: 'CaHA nedir? Biyostimülatörler (Radiesse, Novuma, HArmonyCa, Calhydra, Facetem vb.)',
        paragraphs: [
      ...
      {
        type: 'science',
        title: 'Nasıl kolajen uyarır? — Mekanotransdüksiyon',
        paragraphs: [
          'CaHA’nın kolajen uyarma mekanizması, mikrokürelerin dokuya yerleştikten sonra cildin kolajen üreten hücreleriyle (fibroblastlar) doğrudan fiziksel temasına dayanır. Bilimsel literatürde bu, “mekanotransdüksiyon” olarak adlandırılır: fibroblastlar mikrokürelerin fiziksel varlığını mekanoreseptörleriyle algılar ve bir onarım/yapım sinyali olarak yorumlayıp yeni kolajen üretmeye başlar.',
          'Histolojik çalışmalar, CaHA’nın fibroblastlarla doğrudan teması sonucunda tip I ve tip III kolajen üretiminde belirgin artış (çalışmalarda %160’a varan oranlar bildirilmiştir) sağladığını göstermiştir. Kürelerin arasında fibroblastların temas edebileceği yeterli boşluk olması bu etkinin anahtarıdır — dolayısıyla ürünün ne kadar seyreltildiği (dilüsyon) sonucu doğrudan etkiler.',
        ],
      },
      {
        type: 'image',
        src: '/images/caha-mekanizma.jpg',
        webp: '/images/caha-mekanizma.webp',
        alt: 'CaHA mikrokürelerinin fibroblastları mekanotransdüksiyonla uyararak tip I ve tip III kolajen üretimini tetiklemesi',
        caption: 'CaHA mikroküreleri fibroblastlarla doğrudan temas ederek onları uyarır; sonuçta cilt kendi tip I ve tip III kolajenini yeniden üretmeye başlar.',
      },
      {
        type: 'prose',
        heading: 'Hiperdilüe CaHA — “yüz germe” etkisi buradan gelir',
        paragraphs: [
          'CaHA iki farklı amaçla kullanılabilir. Standart yoğunlukta kullanıldığında hem anında hacim verir hem kolajen uyarır; çene hattı gibi yapısal destek gereken yerlerde tercih edilir. Ancak sıvı yüz germede giderek yaygınlaşan kullanım biçimi “hiperdilüe” (yüksek oranda seyreltilmiş) formdur.',
          'Ürün seyreltildiğinde (örneğin 1:2 oranında) mikroküreler dokuda daha geniş bir alana yayılır; bu da daha çok fibroblastın kürelerle temas etmesini, dolayısıyla daha yaygın kolajen uyarımını sağlar. 1:2 gibi yüksek seyreltmelerde neredeyse hiç anında hacim verilmez; amaç doğrudan doldurmak değil, geniş bir alanda cilt kalitesini ve sıkılığını içeriden iyileştirmektir. Sıvı yüz germede “toparlanma” hissinin bir kısmı tam da bu yaygın kolajen uyarımından gelir.',
        ],
      },
      {
        type: 'comparison',
        ...
        left: [
          ...
          'Etki aylar içinde olgunlaşır ve uzun sürer (~12-18 ay)',
          'Hiperdilüe formda geniş alanda cilt kalitesi hedefler',
          'Hyaluronidaz ile çözülemez; geri alımı HA kadar kolay değildir',
        ],
        right: [
          'Anında hacim ve kontur verir',
          'Etki hemen görülür; tipik olarak ~6-18 ay (ürüne göre)',
          'Nokta bazlı hacim ve şekillendirmede güçlüdür',
          'Hyaluronidaz enzimiyle çözülebilir (geri alınabilir)',
        ],
      },
      {
        type: 'timeline',
        heading: 'CaHA etki süreci',
        steps: [
          { when: '0. gün', title: 'Uygulama', text: 'Krem anestezi sonrası ince iğne veya kanülle uygulanır. Standart formda hafif anında dolgunluk görülebilir; hiperdilüe formda anında etki minimaldir.' },
          { when: '1-2 hafta', title: 'İlk oturma', text: 'Olası şişlik/kızarıklık geriler. Bu aşamada asıl etki henüz başlamamıştır — CaHA’da sabır gerekir.' },
          { when: '4-12 hafta', title: 'Kolajen uyarımı belirginleşir', text: 'Cilt kalitesi, sıkılık ve toparlanma kademeli olarak artar; sonuç “aylar içinde daha iyi” olur.' },
          { when: '12-18 ay', title: 'Etki süresi', text: 'Kolajen temelli iyileşme uzun süre korunur; kişiye göre yenileme planlanır.' },
        ],
      },
      {
        type: 'comparison',
        ...
        rightTitle: 'Ertelenmesi / değerlendirilmesi gerekenler',
        left: [
          'Cilt kalitesini, sıkılığı ve toparlanmayı içeriden iyileştirmek isteyenler',
          'Çene hattı gibi yapısal destek isteyenler (standart form)',
          'Anında büyük değişimden çok kademeli, doğal iyileşme isteyenler',
          'Boyun, dekolte ve el gençleştirmesi düşünenler',
        ],
        right: [
          'Gebelik ve emzirme dönemindekiler',
          'Uygulama bölgesinde aktif enfeksiyon olanlar',
          'Kolayca geri alınabilir bir çözüm şart olanlar (HA daha uygun olabilir)',
          'Bilinen ciddi alerji veya kanama bozukluğu olanlar',
        ],
      },
      {
        ...
        heading: 'Mitler ve gerçekler',
        items: [
          { myth: 'CaHA kemik mi yapar, yüzde sertleşme olur mu?', truth: 'Hayır. İçindeki kalsiyum hidroksiapatit kemik-diş yapısında doğal bulunan bir mineraldir ama dokuda kemik oluşturmaz; fibroblastları uyararak yumuşak kolajen üretimini tetikler.' },
          { myth: 'CaHA da HA gibi hemen geri alınabilir.', truth: 'Hayır. CaHA hyaluronidaz ile çözülmez; bu yüzden doğru planlama ve doğru elde uygulanması daha da önemlidir.' },
          { myth: 'Sonuç anında ortaya çıkar.', truth: 'Hayır. Özellikle hiperdilüe formda asıl etki kolajen uyarımıyla haftalar-aylar içinde oturur. CaHA sabır isteyen bir üründür.' },
          { myth: 'CaHA kalıcıdır.', truth: 'Hayır. Ürün zamanla vücutta parçalanır; uyardığı kolajen etkisi uzun sürse de kalıcı değildir, yenileme gerekir.' },
        ],
      },
      {
        type: 'callout',
        tone: 'warn',
        title: 'Geri alınamaması neden önemli?',
        text: 'HA dolguların en büyük güvenlik avantajı hyaluronidaz ile çözülebilmesidir; CaHA’da bu seçenek yoktur. Bu, CaHA’nın yalnızca anatomiye hâkim, deneyimli bir hekim tarafından, doğru katmana ve doğru dozda uygulanmasını daha da kritik yapar. Bu içerik bilgilendirme amaçlıdır; uygulama kararı muayene ile verilir.',
      },
      {
        type: 'faq',
        heading: 'Sıkça sorulan sorular',
        items: [
          { q: 'CaHA ile HA dolgu arasındaki fark nedir?', a: 'HA dolgu anında hacim verir ve geri alınabilir; CaHA ise cildin kendi kolajenini uyarır, etkisi kademeli ve uzun sürelidir ancak hyaluronidaz ile çözülemez.' },
          { q: 'CaHA kaç ay kalır?', a: 'Kolajen temelli etki tipik olarak 12-18 ay korunur; kişinin cildine, uygulanan bölgeye ve forma göre değişir.' },
      ...
      },
      {
        ...
        heading: 'Kaynaklar ve bilimsel dayanak',
        items: [
          { label: 'Nowag B, et al. Calcium hydroxylapatite microspheres activate fibroblasts through direct contact to stimulate neocollagenesis. J Cosmetic Dermatology, 2023.', url: 'https://onlinelibrary.wiley.com/doi/10.1111/jocd.15521' },
          { label: 'Role of Calcium Hydroxylapatite (Radiesse) as a Regenerative Aesthetic Treatment: A Narrative Review. Aesthetic Surgery Journal, 2023.', url: 'https://academic.oup.com/asj/article/43/10/1063/7249933' },
          { label: 'Skin regeneration-related mechanisms of Calcium Hydroxylapatite (CaHA): a systematic review. PMC.', url: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10273839/' },
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: 'science',
        title: 'Nasıl çalışır? — Kontrollü onarım yanıtı',
        paragraphs: [
          'PLLA’nın kolajen uyarma yolu, CaHA’nın doğrudan fibroblast temasından farklıdır. PLLA parçacıkları dokuya yerleştiğinde, vücut bunları “onarılması gereken bir uyaran” olarak algılar ve kontrollü, hafif bir doku yanıtı başlatır. Doku makrofajları parçacıkları kademeli olarak işler (fagositoz); bu süreçte PLLA yavaşça laktik asit birimlerine ayrışır.',
          'Bu kontrollü yanıt sırasında monositler makrofajlara dönüşür, yabancı cisim dev hücreleri oluşur ve bunlar fibroblastları bölgeye çeker. Fibroblastlar TGF-β1 ve TIMP-1 gibi haberci moleküllerin artışıyla uyarılır ve tip I (ile tip III) kolajen sentezler. Yani PLLA doğrudan hacim koymaz; cildin kendi onarım makinesini çalıştırarak zamanla yapısal kolajen kazandırır.',
          'İnflamatuar yanıt tipik olarak yaklaşık 6 ayda geriler, ancak artmış kolajen birikimi 8-24 ay boyunca gözlenir. PLLA mikropartikülleri değişken bir sürede (yaklaşık 28 aya kadar) tamamen karbondioksit ve suya parçalanır; sonrasında dokuda kalıntı partikül bırakmaz.',
        ],
      },
      {
        type: 'image',
        src: '/images/plla-mekanizma.jpg',
        webp: '/images/plla-mekanizma.webp',
        alt: 'PLLA parçacıklarının makrofajlar ve fibroblastlar aracılığıyla TGF-β1 ve TIMP-1 yoluyla tip I kolajen üretimini kademeli olarak uyarması',
        caption: 'PLLA doğrudan hacim koymaz; kontrollü bir doku yanıtı başlatıp fibroblastları uyararak cildin kendi kolajenini aylar içinde yeniden üretmesini sağlar.',
      },
      {
        type: 'prose',
        heading: 'Neden çoklu seans ve neden sabır?',
        paragraphs: [
          'PLLA’nın en ayırt edici yönü, sonucun “anında” değil “kademeli” olmasıdır. Kolajen üretimi zaman aldığı için etki genellikle birkaç seansa yayılır; her seans arasında cildin yeni kolajeni üretmesi için tipik olarak birkaç haftalık aralık bırakılır. En iyi sonuçlar çoğunlukla birden fazla seansın ardından elde edilir.',
          'Bu yüzden PLLA, “bugün yaptırıp yarın değişmiş görünmek” isteyen için değil; birkaç ay içinde doğal, kademeli ve fark edilmeden tazelenmek isteyen için uygundur. Doğru aday seçildiğinde bu yavaşlık bir dezavantaj değil, sonucun doğal görünmesinin en büyük sebebidir.',
        ],
      },
      {
        type: 'comparison',
        ...
        left: [
          ...
          'Sonuç haftalar-aylar içinde olgunlaşır (8-24 ay etki)',
          'Genellikle çoklu seans gerekir',
          'Geniş alanda yapısal kolajen ve cilt kalitesi hedefler',
        ],
        right: [
          'Anında hacim ve kontur verir',
          'Etki hemen görülür (ürüne göre ~6-18 ay)',
          'Genellikle tek seansta sonuç alınır',
          'Nokta bazlı şekillendirmede güçlü; hyaluronidaz ile geri alınabilir',
        ],
      },
      {
        type: 'timeline',
        heading: 'PLLA etki süreci',
        steps: [
          { when: '0. gün', title: 'Uygulama', text: 'Sulandırılmış PLLA enjekte edilir. İlk günlerde taşıyıcı sıvıya bağlı geçici dolgunluk görülebilir; bu asıl sonuç değildir.' },
          { when: '1. hafta', title: 'Geçici dolgunluk kaybolur', text: 'Taşıyıcı sıvı emilir ve yüz uygulama öncesine yakın görünür. Bu normaldir — kolajen henüz üretilmedi.' },
          { when: '4-12 hafta', title: 'Kolajen üretimi', text: 'Cilt yeni kolajen üretmeye başlar; dolgunluk ve sıkılık kademeli olarak geri gelir. Seanslar bu dönemlere yayılır.' },
          { when: '8-24 ay', title: 'Etki süresi', text: 'Yapısal kolajen etkisi uzun süre korunur. Ürün ~28 ayda tamamen parçalanır, kalıntı bırakmaz.' },
        ],
      },
      {
        type: 'comparison',
        ...
        rightTitle: 'Ertelenmesi / değerlendirilmesi gerekenler',
        left: [
          'Geniş alanda kademeli, doğal hacim ve sıkılık isteyenler',
          'Anında değişimden çok fark edilmeyen tazelenme isteyenler',
          'Çoklu seans ve sabır için uygun olanlar',
          'Yaygın hacim kaybı olan (şakak, yanak) yüzler',
        ],
        right: [
          'Gebelik ve emzirme dönemindekiler',
          'Hızlı / anlık sonuç bekleyenler (HA daha uygun olabilir)',
          'Aktif cilt enfeksiyonu olanlar',
          'Otoimmün / kontrolsüz inflamatuar durumu olanlar (hekim değerlendirmesi)',
        ],
      },
      {
        type: 'myths',
        heading: 'Mitler ve gerçekler',
        items: [
          { myth: 'PLLA da HA gibi anında sonuç verir.', truth: 'Hayır. PLLA kademeli çalışır; asıl sonuç haftalar-aylar içinde, kolajen üretildikçe ortaya çıkar. İlk günkü dolgunluk taşıyıcı sıvıdandır ve geçicidir.' },
          { myth: 'Tek seans yeter.', truth: 'Genellikle hayır. En iyi sonuç çoğunlukla birkaç seansla, aralara kolajen üretimi için zaman bırakılarak elde edilir.' },
          { myth: 'PLLA kalıcıdır.', truth: 'Hayır. Ürün ~28 ayda tamamen parçalanır; uyardığı kolajen uzun sürse de sonuç ömür boyu değildir.' },
          { myth: 'PLLA hyaluronidaz ile geri alınır.', truth: 'Hayır. PLLA HA olmadığından hyaluronidaz ile çözülmez; bu yüzden doğru planlama ve uygulama tekniği kritiktir.' },
        ],
      },
      {
        type: 'callout',
        tone: 'warn',
        title: 'Doğru sulandırma ve teknik neden önemli?',
        text: 'PLLA’da uygulama tekniği (yeterli sulandırma, doğru katman, homojen dağılım) sonucun doğallığı ve nodül gibi istenmeyen durumların önlenmesi açısından belirleyicidir. HA’nın aksine kolayca geri alınamadığından, PLLA anatomiye ve ürüne hâkim bir hekim tarafından uygulanmalıdır. Bu içerik bilgilendirme amaçlıdır; karar muayene ile verilir.',
      },
      {
        type: 'faq',
        heading: 'Sıkça sorulan sorular',
        items: [
          { q: 'PLLA ne zaman etki eder?', a: 'Kademeli çalışır: cilt yeni kolajen ürettikçe, tipik olarak birkaç hafta-ay içinde sonuç belirginleşir. İlk günkü geçici dolgunluk asıl sonuç değildir.' },
          { q: 'Kaç seans gerekir?', a: 'Çoğunlukla birden fazla seans, aralarında birkaç haftalık boşlukla planlanır. Kesin sayı kişiye ve hedefe göre değişir.' },
      ...
      },
      {
        ...
        heading: 'Kaynaklar ve bilimsel dayanak',
        items: [
          { label: 'Poly-L-lactic Acid (Sculptra): A Regenerative Aesthetic Treatment. Cosmetics (MDPI), 2026.', url: 'https://www.mdpi.com/2079-9284/13/3/103' },
          { label: 'Unveiling the Mechanism: Injectable Poly-L-Lactic Acid’s Evolving Role — Insights From Recent Studies. PMC.', url: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC11743305/' },
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: 'science',
        title: 'Nasıl çalışır? — Anında hacim + uzun süreli kolajen',
        paragraphs: [
          'PCL’in çift etkisi, iki bileşeninin farklı zaman ölçeklerinde çalışmasından kaynaklanır. Uygulama anında görülen dolgunluk, taşıyıcı jelin (karboksimetilselüloz) hacminden gelir. Bu jel haftalar içinde emilir; ancak o zamana kadar mikroküreler etrafında yeni kolajen üretimi başlamış olur, böylece hacim kaybolmaz — jelin yerini yavaşça cildin kendi kolajeni alır.',
          'Polikaprolakton mikroküreleri, etraflarında tip I kolajen oluşumunu uyarır (neokolajenez); histolojik çalışmalar mikrokürelerin çevresinde yeni kolajen birikimini göstermiştir. Bu kolajen uyarımı haftalar-aylar boyunca sürer. PCL’in bir diğer özelliği, mikrokürelerin parçalanma hızının üründen ürüne ayarlanabilmesidir: Ellansé’nin farklı formülasyonları (ör. S ve M) farklı etki süreleri sunar.',
        ],
      },
      {
        type: 'image',
        src: '/images/pcl-mekanizma.jpg',
        webp: '/images/pcl-mekanizma.webp',
        alt: 'PCL mikrokürelerinin taşıyıcı jelle anında hacim verirken çevrelerinde tip I kolajen üretimini uyararak uzun süreli etki sağlaması',
        caption: 'PCL çift etkilidir: taşıyıcı jel anında hacim verir, mikroküreler ise çevrelerinde kolajen üretimini uyararak etkiyi uzun süre korur.',
      },
      {
        type: 'list',
        heading: 'Ellansé formülasyonları — süre farkı',
        items: [
          { title: 'Ellansé S', text: 'Daha kısa etkili formülasyon; ürün ömrü tipik olarak yaklaşık 12-18 aydır. Daha kademeli/ölçülü bir plan tercih edildiğinde seçilebilir.' },
          { title: 'Ellansé M', text: 'Daha uzun etkili formülasyon; ürün ömrü tipik olarak yaklaşık 24 aya kadar çıkabilir. Daha uzun süreli sonuç istendiğinde tercih edilebilir.' },
          { title: 'Ortak nokta', text: 'Her iki formda da anında hacim + zamanla kolajen uyarımı birlikte görülür; fark temelde etki süresindedir.' },
        ],
      },
      {
        type: 'comparison',
        ...
        left: [
          ...
          'Süre formülasyona göre ~12-24 ay (S / M)',
          'Anında + kalıcı-uzun etki bir arada isteyene uygun',
          'Hyaluronidaz ile çözülemez',
        ],
        right: [
          'CaHA: doğrudan fibroblast temasıyla kolajen; ~12-18 ay',
          'PLLA: kademeli, çoklu seans; kolajen etkisi 8-24 ay',
          'PLLA anında hacim vermez; CaHA’da hafif anında etki olabilir',
          'İkisi de hyaluronidaz ile çözülemez',
        ],
      },
      {
        type: 'timeline',
        heading: 'PCL etki süreci',
        steps: [
          { when: '0. gün', title: 'Uygulama + anında etki', text: 'Taşıyıcı jel sayesinde hacim ve dolgunluk uygulama anında görülür. Hafif şişlik/kızarıklık olabilir.' },
          { when: '2-6 hafta', title: 'Jel emilir, kolajen devralır', text: 'Taşıyıcı jel yavaşça emilirken mikroküreler çevresinde kolajen üretimi başlar; hacim korunur.' },
          { when: '2-3 ay', title: 'Kolajen etkisi olgunlaşır', text: 'Cilt kalitesi ve sıkılık kademeli olarak artar; sonuç yerine oturur.' },
          { when: '12-24 ay', title: 'Etki süresi (S / M)', text: 'Formülasyona göre etki uzun süre korunur; süre dolduğunda yenileme planlanır.' },
        ],
      },
      {
        type: 'comparison',
        ...
        rightTitle: 'Ertelenmesi / değerlendirilmesi gerekenler',
        left: [
          'Hem anında hem uzun süreli sonuç isteyenler',
          'Uzun etki süresi öncelik olanlar (özellikle Ellansé M)',
          'Yapısal destek + cilt kalitesi birlikte hedeflenenler',
          'Sık yenileme istemeyenler',
        ],
        right: [
          'Gebelik ve emzirme dönemindekiler',
          'Kolayca geri alınabilir çözüm şart olanlar (HA daha uygun)',
          'Aktif cilt enfeksiyonu olanlar',
          'Bilinen ciddi alerji veya kanama bozukluğu olanlar',
        ],
      },
      {
        ...
        heading: 'Mitler ve gerçekler',
        items: [
          { myth: 'PCL sadece dolgu, kolajen uyarmaz.', truth: 'Yanlış. PCL çift etkilidir: jel anında hacim verir, mikroküreler ise çevresinde tip I kolajen üretimini uyarır.' },
          { myth: 'PCL kalıcıdır.', truth: 'Hayır. Polikaprolakton biyobozunur bir polimerdir; formülasyona göre ~12-24 ay sürer ve zamanla parçalanır.' },
          { myth: 'PCL de HA gibi hyaluronidaz ile geri alınır.', truth: 'Hayır. PCL HA olmadığından hyaluronidaz ile çözülmez; doğru planlama ve uygulama bu yüzden kritiktir.' },
          { myth: 'PLLA ve PCL aynı şeydir.', truth: 'Hayır. PLLA genelde anında hacim vermez ve çoklu seans ister; PCL ise anında hacim + kolajeni tek üründe birleştirir. Farklı moleküller, farklı planlar.' },
        ],
      },
      {
        type: 'callout',
        tone: 'warn',
        title: 'Uzun etki, doğru planlama ister',
        text: 'PCL’in avantajı olan uzun etki süresi, aynı zamanda doğru planlamayı daha da önemli kılar: HA gibi kolayca geri alınamadığından, ürün seçimi (S/M), katman ve doz kişiye özel ve anatomiye hâkim bir hekim tarafından belirlenmelidir. Bu içerik bilgilendirme amaçlıdır; karar muayene ile verilir.',
      },
      {
        type: 'faq',
        heading: 'Sıkça sorulan sorular',
        items: [
          { q: 'PCL anında sonuç verir mi?', a: 'Evet. Taşıyıcı jel sayesinde uygulama anında hacim görülür; ardından mikrokürelerin uyardığı kolajen bu etkiyi uzun süre korur.' },
          { q: 'Ellansé S ile M farkı nedir?', a: 'Temel fark etki süresidir: S tipik olarak ~12-18 ay, M ~24 aya kadar sürebilir. Seçim hedefe ve kişiye göre yapılır.' },
      ...
      },
      {
        ...
        heading: 'Kaynaklar ve bilimsel dayanak',
        items: [
          { label: 'Polycaprolactone: How a Well-Known and Futuristic Polymer Has Become an Innovative Collagen-Stimulator. Clinical, Cosmetic and Investigational Dermatology (Dove Press).', url: 'https://www.dovepress.com/polycaprolactone-how-a-well-known-and-futuristic-polymer-has-become-an-peer-reviewed-fulltext-article-CCID' },
          { label: 'Pilot Study: Efficacy and Safety of Polycaprolactone Collagen Stimulator for Middle Third of the Face. PRS Global Open, 2025.', url: 'https://journals.lww.com/prsgo/fulltext/2025/11000/pilot_study__efficacy_and_safety_of.26.aspx' },
