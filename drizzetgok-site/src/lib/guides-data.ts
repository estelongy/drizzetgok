...
export const GUIDES: GuideData[] = [
  ...
  },
  {
    slug: 'sivi-yuz-germe',
    category: 'Yüz Germe',
    title: 'Sıvı Yüz Germe (Liquid Facelift): Cerrahisiz Yüz Gençleştirmenin Bilimi',
    metaTitle: 'Sıvı Yüz Germe Nedir? Liquid Facelift Nasıl Yapılır, Kaç Ay Kalır? | Dr. İzzet Gök',
    excerpt:
      'Sıvı yüz germe (liquid facelift) nedir, cerrahisiz nasıl “germe” etkisi yaratır, ameliyatın yerini tutar mı ve kimlere uygundur? Yüzün hacimsel yaşlanması, çok-noktalı dolgu + biyostimülatör + botoks tekniği, güvenlik ve işlem sonrası bakım — Dr. İzzet Gök kontrolünde, bilimsel dayanaklı.',
    heroEyebrow: 'Medikal Estetik Rehberi',
    readingMinutes: 11,
    updated: '2026-07-12',
    relatedServiceSlug: 'sivi-yuz-germe',
    relatedGuides: ['dolgu', 'botoks-nedir', 'ha-biyostimulator-farki'],
    color: 'from-violet-500 to-purple-500',
    blocks: [
      {
        type: 'prose',
        heading: 'Sıvı yüz germe nedir?',
        paragraphs: [
          'Sıvı yüz germe (liquid facelift), cildi kesip germek yerine; yüzün stratejik noktalarına enjeksiyonla verilen desteğin, hatları yukarı taşıyıp dinlendirdiği cerrahisiz bir yüz gençleştirme protokolüdür. “Sıvı” sözcüğü, işlemin bıçakla değil, akışkan ürünlerle — iğne ve kanülle — yapıldığını anlatır.',
          'Kritik nokta şudur: sıvı yüz germe tek bir enjeksiyon değil, bir plandır. Amaç tek tek kırışıklıkları doldurmak değil; yüzü bütün olarak okuyup, yaşla kaybolan desteği doğru noktalardan geri vermektir. Sonucu belirleyen ürün miktarı değil, hangi noktaya, hangi derinliğe, ne kadar uygulanacağının tasarımıdır.',
          'İşlemde tek bir malzeme kullanılmaz. Sıklıkla hyaluronik asit (HA) dolgular hacim ve destek için; yerine göre cildin kendi kollajenini uyaran biyostimülatör dolgular (ör. kalsiyum hidroksiapatit, poli-L-laktik asit) uzun vadeli doku kalitesi için; üst yüzde ise botoks mimik çizgileri için birlikte planlanır. Bu malzemeler arasındaki farkı “HA mı, biyostimülatör mü?” rehberinde ayrıntılı ele alıyoruz.',
        ],
      },
      {
        type: 'prose',
        heading: 'Yüz gerçekte nasıl yaşlanır?',
        paragraphs: [
          'Yaşlanan yüz uzun süre yalnızca “sarkan” yüz olarak görüldü. Oysa modern anatomi bunun yarım bir tablo olduğunu gösterdi: yaşlanma büyük ölçüde hacimseldir. Yüz yağı, birbirinden bağımsız “yağ bölmeleri” hâlinde dizilir; bu bölmeler yıllar içinde hem erir hem de aşağı kayar.',
          'Rohrich ve Pessa’nın kadavra çalışması, yanak yağının tek bir kütle değil, ayrı ayrı bölmeler olduğunu ortaya koydu. Bu bölmeler inceldikçe elmacık desteği düşer, nazolabial oluk derinleşir ve yüz aşağı “akmış” gibi görünür. Buna kemik erimesi (özellikle üst çene ve göz çukuru kenarında) ve tutucu bağların gevşemesi eklenince tablo tamamlanır.',
          'Sıvı yüz germenin bütün mantığı buradan doğar: sorun ağırlıklı olarak kaybolan hacimse, çözüm o hacmi doğru katmandan geri vermektir. Fazlalığı kesip almak yerine altındaki iskeleyi yeniden kurmak — hissedilen “germe” işte bu yeniden kurulan destekten gelir.',
        ],
      },
      {
        type: 'image',
        src: '/images/dolgu-bolge.jpg',
        webp: '/images/dolgu-bolge.webp',
        alt: 'Yüz bölge haritası: elmacık, şakak, göz altı, nazolabial, çene hattı ve çevre bölgeler işaretli — sıvı yüz germenin çok-noktalı destek mantığı',
        caption: 'Sıvı yüz germe yüzü tek noktadan değil, birbirini destekleyen bir noktalar ağından ele alır. Bir bölgeye verilen destek, komşu bölgeyi de toparlar.',
      },
      {
        type: 'list',
        heading: 'Yüzün hangi bölgeleri haritalanır?',
        items: [
          { title: 'Elmacık / orta yüz', text: 'Yüzün “çadır direği”. Buraya verilen destek yanağı yukarı taşır ve alt yüzdeki gevşemeyi belirgin biçimde hafifletir — çoğu planın başlangıç noktasıdır.' },
          { title: 'Şakak (temporal bölge)', text: 'Yaşla çöken şakak, kaşı ve gözün dış köşesini düşürür. Buraya verilen hacim üst yüzü dolgunlaştırır ve bakışı açar.' },
          { title: 'Göz altı (tear trough)', text: 'Tek başına değil, elmacık desteğiyle birlikte ele alınır; yorgun ve çökük göz altı görünümünü dengeler.' },
          { title: 'Nazolabial ve ağız kenarı', text: 'Burun-dudak oluğu ve düşen ağız kenarları (marionette) çoğu zaman doğrudan değil, üstteki elmacık desteklenerek yumuşatılır.' },
          { title: 'Çene hattı ve yüz ovali (jawline)', text: 'Net bir çene hattı ve dengeli çene ucu, alt yüzü toparlar, “sarkmış” görünümü azaltır ve profili düzeltir.' },
          { title: 'Üst yüz (botoks)', text: 'Alın, kaş arası ve göz kenarı mimik çizgileri botoksla yumuşatılır; uygun kişide hafif bir kaş yükselmesi de elde edilebilir.' },
        ],
      },
      {
        type: 'prose',
        ...
        paragraphs: [
          'Buradaki germe etkisi cildi çekmekten değil, yüzün alttan iskelesini yeniden kurmaktan gelir. Yapısal dolgular yüzeye değil, çoğunlukla kemik üstündeki derin plana yerleştirilir; böylece bir çizgiyi doldurmaktan çok, çökmüş dokuya alttan bir sütun görevi görür. Elmacık gibi taşıyıcı bir noktaya verilen destek, üzerindeki tüm dokuları yukarı taşır ve yüz kendi kendine “toparlanır”.',
          'Botoks bu tabloya farklı bir yoldan katkı verir: üst yüzdeki mimik kaslarını yumuşatır, dinamik çizgileri azaltır ve dolgunun yükünü paylaşır. Hacmi geri veren dolgu ile mimiği dengeleyen botoks birlikte kullanıldığında, ikisinin tek başına ulaşamayacağı bütüncül ve dengeli bir sonuç ortaya çıkar.',
        ],
      },
      {
        type: 'science',
        title: 'Daha derin: dolgu reolojisi (G′) ve SMAS desteği',
        paragraphs: [
          'Bir dolgunun “taşıyıcı” olabilmesi, reolojik bir özellik olan yüksek elastik modüle (G′) bağlıdır. G′ yüksek jeller baskı altında şeklini korur ve projeksiyon/kaldırma sağlar; bu yüzden kemik üstü (supraperiosteal) derin plana yerleştirildiklerinde üstteki yumuşak dokuya sabit bir dayanak oluştururlar.',
          'de Maio’nun yaygın kullanılan MD Codes yaklaşımında, belirli çıpa (anchor) noktalarına kemik seviyesine kadar uygulanan küçük hacimlerin, üstteki SMAS (mimik kaslarını ve yüzeyel fasyayı içeren tabaka) katmanını yukarı taşıyarak lifting etkisi yarattığı tarif edilir. Yani lift, cildi germekten değil, alttaki mimari desteği yeniden kurmaktan doğar.',
          'Biyostimülatör dolgular ise mekanik desteğe ek olarak farklı bir yolla çalışır: cilt altında kontrollü bir onarım yanıtı başlatıp yeni kollajen üretimini (neokolajenez) tetikler. Böylece etki, dolgunun hacminden bağımsız olarak zamanla doku kalitesinin iyileşmesiyle de sürer.',
        ],
      },
      {
        type: 'timeline',
        heading: 'Süreç: planlamadan sonuca',
        steps: [
          { when: 'Konsültasyon', title: 'Yüz analizi ve plan', text: 'Sarkma derecesi, hacim kaybı ve oranlar değerlendirilir; fotoğraflanır ve kişiye özel nokta haritası ile malzeme planı çıkarılır.' },
          { when: '0. gün', title: 'Uygulama', text: 'Krem anestezi sonrası üst yüze botoks, belirlenen noktalara iğne/kanülle dolgu uygulanır. İşlem genellikle 60-90 dakika sürer.' },
          { when: '24-48 saat', title: 'Şişlik ve kızarıklık', text: 'Hafif şişlik, kızarıklık veya morluk beklenen ve geçici bir durumdur; çoğu kişi ertesi gün günlük hayatına döner.' },
          { when: '2 hafta', title: 'Oturma ve kontrol', text: 'Botoksun tam etkisi ve dolgunun yerine oturması bu dönemde tamamlanır; nihai sonuç için kontrol muayenesi yapılır.' },
          { when: '12-18 ay', title: 'Yenileme', text: 'HA dolgular zamanla emilir; etki azaldığında protokol tercihe bağlı olarak tazelenir. Biyostimülatörün doku etkisi daha uzun sürebilir.' },
        ],
      },
      {
        type: 'prose',
        heading: 'Ameliyatın (yüz germe cerrahisinin) yerini tutar mı?',
        paragraphs: [
          'Dürüst yanıt: bazen evet, bazen hayır. Sıvı yüz germe; erken-orta düzey hacim kaybı ve hafif-orta gevşemede cerrahiye güçlü bir alternatiftir. Anestezi, kesi ve uzun iyileşme olmadan, geri alınabilir ve kademeli bir iyileşme sunar. Bu yüzden genellikle 35-55 yaş aralığında en iyi sonucu verir.',
          'Ancak ileri düzey cilt fazlası ve yer çekimine bağlı belirgin sarkmada, dokuyu fiilen çıkarıp gerecek olan cerrahi daha doğru sonucu verir; bu tabloda hacim eklemek yüzü toparlamak yerine ağırlaştırabilir. Kalıcılık açısından da fark vardır: sıvı yüz germe ortalama 12-18 ay, cerrahi yüz germe ise yıllarca sürer. Doğru seçim, ancak yüz yüze bir değerlendirmeyle netleşir — kliniğimizde bu kararı sizinle birlikte, gerçekçi biçimde veririz.',
        ],
      },
      {
        type: 'comparison',
        ...
        rightTitle: 'Ertelenmesi / değerlendirilmesi gerekenler',
        left: [
          'Erken-orta düzey hacim kaybı ve hafif-orta gevşeme',
          'Cerrahi, anestezi ve uzun iyileşme istemeyenler',
          'Doğal, kademeli ve geri alınabilir sonuç arayanlar',
          'Gerçekçi beklentisi olanlar',
        ],
        right: [
          'Gebelik ve emzirme dönemindekiler',
          'Uygulama bölgesinde aktif uçuk (herpes), akne veya enfeksiyon olanlar',
          'Kanama bozukluğu olan veya kan sulandırıcı kullananlar (hekime danışılmalı)',
          'İleri sarkma ya da abartılı/gerçekçi olmayan beklenti (önce konsültasyon)',
        ],
      },
      {
        type: 'image',
        src: '/images/dolgu-uygulama.jpeg',
        webp: '/images/dolgu-uygulama.webp',
        alt: 'Dr. İzzet Gök, klinik ortamda bir hastaya kanülle dolgu uygularken',
        caption: 'Sıvı yüz germe, yüz anatomisine ve derinlik planlarına hâkim bir hekim tarafından, steril klinik ortamda uygulanmalıdır. Görsel: Dr. İzzet Gök kliniğinden.',
      },
      {
        type: 'myths',
        heading: 'Mitler ve gerçekler',
        items: [
          { myth: 'Sıvı yüz germe ameliyatın yerini her koşulda tutar.', truth: 'Hayır. Erken-orta düzey değişimde güçlü bir alternatiftir; ileri sarkmada cerrahi daha doğru sonuç verir. Karar konsültasyonda dürüstçe verilir.' },
          { myth: 'Yüzümü “dondurur”, ifademi bozar.', truth: 'Hayır. Dolgu kasları hareketsiz bırakmaz; botoks ise doğru dozda ifadeyi korur. Gülüş ve bakış gibi temel mimikler yerinde kalır.' },
          { myth: 'Ne kadar çok dolgu, o kadar genç görünüm.', truth: 'Hayır. Aşırı hacim yüzü doğallıktan uzaklaştırır ve şişkin gösterir. Hedef “az ama doğru noktaya”dır.' },
          { myth: 'Sonuç kalıcıdır.', truth: 'Hayır. HA dolgular 12-18 ayda doğal olarak emilir, botoksun etkisi 4-6 aydır. Bu geçicilik aynı zamanda bir güvenlik avantajıdır.' },
          { myth: 'Hemen sosyal hayata dönerim, hiç iz kalmaz.', truth: 'Sonuç anında fark edilir ama ilk 24-48 saat hafif şişlik/morluk olabilir. Önemli bir etkinlik öncesi işlemi birkaç gün önceden planlamak akıllıcadır.' },
        ],
      },
      {
        type: 'callout',
        tone: 'warn',
        title: 'Güvenliğin merkezi: anatomi, hekim ve steril ortam',
        text: 'Sıvı yüz germe ileri düzey bir işlemdir ve yüzün damar haritasına hâkimiyet gerektirir. En ciddi (ama nadir) risk, dolgunun bir damarı tıkamasıdır (vasküler oklüzyon). Bu yüzden uygulama; doğru derinlik, onaylı ürün ve dikkatli teknikle, deneyimli bir hekim tarafından ve steril klinik ortamda yapılmalıdır — “merdiven altı” uygulamalardan kaçınılmalıdır. HA dolguların önemli avantajı gerektiğinde hyaluronidaz enzimiyle çözülebilmesidir; biyostimülatör dolgular ise geri döndürülemez, bu yüzden malzeme seçimi baştan birlikte planlanır. Gebelik/emzirme, aktif herpes veya enfeksiyon, kanama bozukluğu ve bilinen alerji durumunda işlem ertelenir. Not: mevzuat gereği sağlıkta “en iyi” gibi üstünlük ifadeleri kullanılmaz; sonucu belirleyen, hekim deneyimi ve kişiye uygun plandır. Bu içerik bilgilendirme amaçlıdır.',
      },
      {
        type: 'faq',
        heading: 'Sıkça sorulan sorular',
        items: [
          { q: 'Sıvı yüz germe kaç ay/yıl kalır?', a: 'HA dolgu etkisi genellikle 12-18 ay, botoks etkisi 4-6 aydır. Biyostimülatörün doku üzerindeki etkisi daha uzun sürebilir. Süre; kullanılan ürüne, bölgeye ve metabolizmaya göre değişir.' },
          { q: 'Sonuç ne zaman görülür?', a: 'Dolgunun hacim etkisi işlemin hemen ardından fark edilir; şişlik dağıldıkça birkaç gün içinde netleşir. Botoksun tam etkisi ise 14. günde oturur.' },
          { q: 'İşlem ağrılı mı?', a: 'Krem anestezi ve çoğu dolgunun içindeki lidokain sayesinde rahatsızlık genellikle azdır. Kanül kullanımı konforu artırır ve morluk riskini azaltır.' },
          { q: 'İfadelerim/mimiklerim etkilenir mi?', a: 'Hayır. İşlem kas hareketlerini donduran bir uygulama değildir; gülüş, bakış ve temel ifadeler korunur. Botoks yalnızca üst yüzde ve doğru dozda kullanılır.' },
          { q: 'Kaç yaşında yaptırılır?', a: 'Genellikle 35-55 yaş aralığında, erken-orta düzey hacim kaybı ve hafif-orta gevşemede en iyi sonucu verir. Karar sarkma derecesine göre kişiye özeldir.' },
          { q: 'Memnun kalmazsam geri alınabilir mi?', a: 'HA esaslı dolgular hyaluronidaz enzimiyle çözülebilir; botoksun etkisi zamanla kendiliğinden geçer. Biyostimülatör dolgular ise geri döndürülemez — bu yüzden malzeme seçimi konsültasyonda birlikte kararlaştırılır.' },
          { q: 'İşlem sonrası nelere dikkat etmeliyim?', a: 'İlk 24-48 saat: bölgeye masaj/baskı ve ovuşturma yapmamak, ağır spordan, sauna-hamam ve aşırı sıcaktan kaçınmak, alkolü ve aşırı tuzu sınırlamak, mümkünse sırt üstü yatmak önerilir. Lazer ve yoğun cilt bakımı için 1-2 hafta beklenir. Aktif uçuğu (herpes) olanlarda işlem ertelenir; detaylı bakım size özel anlatılır.' },
        ],
      },
      {
        type: 'sources',
        heading: 'Kaynaklar ve bilimsel dayanak',
        items: [
          { label: 'Rohrich RJ, Pessa JE. The Fat Compartments of the Face: Anatomy and Clinical Implications for Cosmetic Surgery. Plast Reconstr Surg. 2007.', url: 'https://pubmed.ncbi.nlm.nih.gov/17519724/' },
          { label: 'de Maio M. MD Codes™: A Methodological Approach to Facial Aesthetic Treatment with Injectable Hyaluronic Acid Fillers. Aesthetic Plast Surg. 2021.', url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC8012343/' },
          { label: 'U.S. Food & Drug Administration (FDA) — Dermal Fillers (Soft Tissue Fillers) hasta bilgilendirmesi.' },
        ],
      },
    ],
