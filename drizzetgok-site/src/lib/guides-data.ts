...
export const GUIDES: GuideData[] = [
  ...
  },
  {
    ...
    title: 'CaHA (Radiesse) Nedir? — Kalsiyum Hidroksiapatit Biyostimülatör Rehberi',
    metaTitle: 'CaHA / Radiesse Nedir? Kolajen Uyarıcı Etkisi, Kaç Ay Kalır? | Dr. İzzet Gök',
    excerpt:
